  ...
  return (
    <div className="min-h-screen bg-background" data-testid="landing-page">
      <SEO 
        ...
        description="Discover universities, find scholarships, and get expert guidance for higher education in Uganda. Apply to Makerere, UCU, KIU and 30 universities."
        canonical="/"
      ...
      <section className="hero-gradient py-10 sm:py-16 lg:py-24 relative" data-testid="hero-section">
        <div className="container mx-auto px-4 lg:px-6 relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            ...
            {/* Quick Stats */}
            <div className="grid grid-cols-2 gap-4 sm:gap-6 max-w-md mx-auto animate-fade-in-up delay-500" data-testid="quick-stats">
              <div className="text-center glass rounded-lg p-4 hover:scale-105 transition-transform duration-300">
                <div className="text-xl sm:text-3xl font-bold text-white stat-number" data-testid="stats-universities">30</div>
      ...
      <section className="py-10 sm:py-16 lg:py-20 hero-gradient" data-testid="cta-section">
        <div className="container mx-auto px-4 lg:px-6 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            {/* Trust Indicators */}
            <div className="mt-8 sm:mt-12 grid grid-cols-3 gap-4 sm:gap-8 max-w-xl mx-auto" data-testid="trust-indicators">
              <div className="text-center">
              ...
              <div className="text-center">
                <div className="text-xl sm:text-3xl font-bold text-white">30</div>
