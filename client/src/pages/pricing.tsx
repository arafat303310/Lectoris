    ...
    <div className="min-h-screen bg-background" data-testid="pricing-page">
      ...
      <section className="py-16 lg:py-20 bg-gradient-to-b from-primary/5 to-background">
        <div className="container mx-auto px-4 lg:px-6 text-center">
          <Badge variant="secondary" className="mb-4" data-testid="pricing-badge">
            Simple, Transparent Pricing
          </Badge>
          <h1 className="text-4xl lg:text-5xl font-bold text-foreground mb-4" data-testid="pricing-title">
            ...
            {pricingTiers.map((tier) => (
              ...
              >
                ...
                <CardHeader className="text-center pb-4">
                  ...
                  <CardTitle className="text-2xl" data-testid={`tier-name-${tier.name.toLowerCase()}`}>
                    {tier.name}
                  </CardTitle>
                ...
                <CardContent className="flex-1">
                  <div className="text-center mb-6">
                    <span className="text-4xl font-bold text-foreground" data-testid={`tier-price-${tier.name.toLowerCase()}`}>
              ...
              >
                ...
                <CardFooter>
                  <Link href="/services" className="w-full">
                    <Button variant="outline" className="w-full" data-testid={`service-cta-${index}`}>
                      Learn More
                    </Button>
                  </Link>
                </CardFooter>
      ...
      <section className="py-12 lg:py-16">
        <div className="container mx-auto px-4 lg:px-6">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-3xl font-bold text-foreground text-center mb-8" data-testid="faq-title">
              Frequently Asked Questions
            </h2>
            <div className="space-y-6">
              <div className="bg-card rounded-lg p-6 border border-border" data-testid="faq-1">
              ...
              <div className="bg-card rounded-lg p-6 border border-border" data-testid="faq-2">
                <h3 className="font-semibold text-foreground mb-2">
              ...
              <div className="bg-card rounded-lg p-6 border border-border" data-testid="faq-3">
                <h3 className="font-semibold text-foreground mb-2">
              ...
              <div className="bg-card rounded-lg p-6 border border-border" data-testid="faq-4">
                <h3 className="font-semibold text-foreground mb-2">
